		...
		<>
			<div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
				...
				<form className="space-y-4">
					...
					<button type="submit" className="w-full bg-emerald-600 hover:bg-emerald-700 hover:cursor-pointer text-white font-medium py-2.5 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed">Cadastrar-se</button>
				</form>
				<button className="w-full mt-4 text-sm text-slate-600 hover:text-slate-800 transition">Já tem conta? Entre</button>
			</div>
		</>
	)
}
